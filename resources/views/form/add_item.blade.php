  <div class="modal-overlay" id="addModal" onclick="if(event.target===this)closeModal()">
      <div
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
              <form method="POST" action="{{ route('items.store') }}" style="display:contents;">
                  @csrf
                  ...
                  <div>
                      ...
                      <select name="category"
                          ...
                          <option value="Internal Hardware">Internal Hardware</option>
                  ...
                  <div style="grid-column:1/-1;">
                      ...
                      <textarea name="remarks" placeholder="Any additional notes about this item…" rows="2"
                  ...
                  <div style="display:flex;gap:10px;margin-top:18px;justify-content:flex-end;">
                      ...
                      <button type="submit"
                          ...
                          onmouseout="this.style.background='#1d3577'">Save
                          Item</button>
                  </div>
              </form>
          </div>
